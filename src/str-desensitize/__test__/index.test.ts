...
describe('desensitize-脱敏测试', () => {
  ...
  test('bankCard', () => {
    expect(desensitize('6226 8372 9938 0192', 'bankCard')).toBe(
      '6226 **** **** 0192',
    );
  });
  test('IDCard', () => {
    expect(desensitize('110291202312120488', 'IDCard')).toBe(
      '110291********04**',
    );
  });
  test('name', () => {
  ...
  test('telephone', () => {
    expect(desensitize('0571-87006789-1234', 'telephone')).toBe(
      '0571-8700****-12**',
    );
  });
});
